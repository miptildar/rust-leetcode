...
impl Solution {
    pub fn rotate(matrix: &mut Vec<Vec<i32>>) {
        ...
        loop {
            ...
            let rotate1 = Solution::rotate_value(matrix, i, j, None);
            visited[rotate1.0 as usize][rotate1.1 as usize] = true;

            let rotate2 = Solution::rotate_value(matrix, rotate1.0, rotate1.1, Some(rotate1.2));
            visited[rotate2.0 as usize][rotate2.1 as usize] = true;

            let rotate3 = Solution::rotate_value(matrix, rotate2.0, rotate2.1, Some(rotate2.2));
            visited[rotate2.0 as usize][rotate2.1 as usize] = true;

            let rotate4 = Solution::rotate_value(matrix, rotate3.0, rotate3.1, Some(rotate3.2));
    ...
    fn rotate_value(matrix: &mut Vec<Vec<i32>>, i1: i32, j1: i32, removed: Option<i32>) -> (i32, i32, i32) {
        let new_position = Solution::find_rotated_position(i1, j1, matrix.len() as i32);
